...
function tellFortune(childNumber, partnerName, location, jobTitle) {
...
function main() {
  const numKids = [1, 2, 3, 0, 5];

  const partnerNames = ['Micheal', 'Pam', 'Dwight', 'Angela', 'Jim'];

  const locations = ['office', 'jungle', 'ocean', 'space', 'land'];
