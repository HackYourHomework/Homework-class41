...
// ! Function under test
function sanitizeFruitBasket(fruitBasket, filteredOutFruits) {
  // TODO complete this function
   return fruitBasket.filter(fruits => fruits !== filteredOutFruits)
}
...
describe('sanitizeFruitBasket', () => {
  ...
  test('should return a new array that does not include the unwanted `lemon`', () => {
    // TODO replace next line with your code
    expect(sanitizeFruitBasket(fruitBasket, 'lemon')).not.toContain([
      'lemon', ]);
    });
});
