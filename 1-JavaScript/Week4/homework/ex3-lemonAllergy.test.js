...
// ! Function under test
function sanitizeFruitBasket(fruitBasket, removeFruit) {
  let fruitsWithoutLemon = [];
  fruitsWithoutLemon = fruitBasket.filter((fruit) => fruit !== removeFruit);
  return fruitsWithoutLemon;
}
