...
/*------------------------------------------------------------------------------
  The problem was resolved because the promises help us to catch the error once. 
  Only one state is possible resolve or reject. 
  That is why once rejected promise don't message "Success anymore".
------------------------------------------------------------------------------*/
