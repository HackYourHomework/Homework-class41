...
/*
The problem doesn't occur anymore because when we changed the callbacks to promises we it isn't possible to 
to get error callback then success callback, in promises its either a error or a success message.
*/
